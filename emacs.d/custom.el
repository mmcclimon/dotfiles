(custom-set-variables
 ...
 '(projectile-mode-line '(:eval (format " ρ[%s]" (projectile-project-name))))
 '(reftex-bibliography-commands
   '("bibliography" "nobibliography" "setupbibtex\\[.*?database=" "addbibresource"))
 '(reftex-label-alist '(("example" 120 nil nil nil ("Example"))))
...
(custom-set-faces
 ...
 '(fill-column-indicator ((t (:stipple nil :foreground "gray28" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal)))))
